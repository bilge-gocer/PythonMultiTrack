...
def parse_client_header(record):
    ...
    return {'record_type': record_type, 'account_no_dec':account_no_dec, 'transaction_records':transaction_records}
...
def parse_client_transaction(record):
    ...
    return {'record_type':record_type, 'transaction_date':transaction_date, 'transaction_type':transaction_type, 'transaction_amount':transaction_amount, 'third_party_account':third_party_account}
...
def parse_record(record):
    ...
    if record_type == 'FH':
        ...
        transaction = Transaction(detail.get("transaction_date"), detail.get("transaction_type"),
                                  detail.get("transaction_amount"), detail.get("third_party_account"))
...
records = [
    ...
    'CT19032019:132508C000000000147.1400001948847238383813',
    'FF'
...
# transaction1 = Transaction(None, "D", 123.45, 123456)
# transaction2 = Transaction(None, "C", 456.78, 123456)
#
# print(transaction1.transaction_amount)
# print(transaction1)
