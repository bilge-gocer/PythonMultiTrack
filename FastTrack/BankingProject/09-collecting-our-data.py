...
def parse_client_transaction(record):
    ...
    return record_type, transaction_date, transaction_amount, third_party_account
...
detail = parse_client_transaction('CT19032019:132508C000000000147.1400001948847238383813')
print_detail(detail)
